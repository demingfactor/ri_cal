...
# -*- encoding: utf-8 -*-
# stub: demingfactor-ri_cal 0.10.0 ruby lib

Gem::Specification.new do |s|
  s.name = "demingfactor-ri_cal".freeze
  s.version = "0.10.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Rick DeNatale".freeze, "Demingfactor".freeze]
  s.date = "2024-03-05"
  ...
  s.email = "dev@demingfactor.com".freeze
  s.executables = ["ri_cal".freeze]
  s.extra_rdoc_files = [
    "History.txt",
    "README.txt",
    "copyrights.txt"
  ...
  s.homepage = "http://github.com/demingfactor/ri_cal".freeze
  s.rubygems_version = "3.0.3.1".freeze
  s.summary = "a new implementation of RFC2445 in Ruby".freeze
end
